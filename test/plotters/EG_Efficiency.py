...
#saveWhere='../plots/Iso40/EG_Iso40_Efficiency'
#saveWhere='../plots/Iso30/EG_Iso30_Efficiency'
#saveWhere='../plots/Iso25/EG_Iso25_Efficiency'
saveWhere='../plots/Iso20/EG_Iso20_Efficiency'

########
# File #
########
#Efficiency
#eff_ntuple = '../data/EG_Iso40_Efficiency.root'
#eff_ntuple = '../data/EG_Iso30_Efficiency.root'
#eff_ntuple = '../data/EG_Iso25_Efficiency.root'
eff_ntuple = '../data/EG_Iso20_Efficiency.root'
...
# UCT Rlx + Isolation by hand
 if drawUCTIso_byhand_:
  cut_UCT_isoByHand=recoPtCut+'&&'+l1gPtCut+'&& l1gMatch && (dr03CombinedEt/recoPt)<0.2 &&'+isoCut
